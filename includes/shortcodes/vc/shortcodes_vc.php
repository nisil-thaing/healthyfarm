...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"class" => "",
			"value" => "",
				// Uncomment this row, if you want display content after admin labels
			"type" => "textarea_html"
        ),*/
        THEMEREX_VC_width(),
		THEMEREX_VC_height(),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
            ...
            "description" => __("Any color for text color", "themerex"),
			"class" => "",
			"value" => "",
			"type" => "colorpicker"
        ),
        ...
        array(
			"param_name" => "width",
			"heading" => __("Width button", "themerex"),
			"description" => __("Specifies the width of the button", "themerex"),
			"value" => "",
			"type" => "textfield"
		),
		array(
			"param_name" => "height",
			"heading" => __("Height button", "themerex"),
			"description" => __("Specifies the height of the button", "themerex"),
			"value" => "",
			"type" => "textfield"
		),
		$THEMEREX_VC_margin_top,
...
vc_map( array(
	...
	"params" => array(
        ...
        array(
			"param_name" => "indent",
			"heading" => __("Indent", "themerex"),
			"class" => "",
			"value" => array(__('Show indent', 'themerex') => 'yes'),
			"type" => "checkbox"
        ),
		THEMEREX_VC_width(),
		$THEMEREX_VC_margin_top,
...
vc_map( array(
	...
	"description" => __("Insert contact info", "themerex"),
	"category" => __('Content', 'js_composer'),
    'icon' => 'icon_trx_contact_form',
...
vc_map( array(
	...
	"params" => array(
        ...
        array(
			...
			"class" => "",
			"value" => array(__('Scroll', 'themerex') => 'yes'),
			"type" => "checkbox"
        ),
		array(
			"param_name" => "style",
...
vc_map( array(
	...
	"description" => __("Hide any block", "themerex"),
	"category" => __('Content', 'js_composer'),
    'icon' => 'icon_trx_block',
...
vc_map( array(
	...
	"params" => array(
        ...
        array(
			"param_name" => "link",
			"heading" => __("Link URL", "themerex"),
            "description" => __("URL for link on icon click", "themerex"),
			"class" => "",
			"value" => "",
			"type" => "textfield"
        ),
...
vc_map( array(
	...
	"params" => array(
        ...
        array(
			"param_name" => "title",
			"heading" => __("Title", "themerex"),
            "description" => __("Infobox's title", "themerex"),
			"admin_label" => true,
			"class" => "",
			"value" => "",
			"type" => "textfield"
	...
	"params" => array(
        ...
        array(
         ...
         array(
            ...
            "description" => __("URL for quote cite", "themerex"),
			"class" => "",
			"value" => "",
			"type" => "textfield"
        ),/*
...
vc_map( array(
	...
	"params" => array(
		array(
			"param_name" => "align",
			"heading" => __("Alignment", "themerex"),
            "description" => __("Align object to left, center or right", "themerex"),
			"admin_label" => true,
			"class" => "",
			"value" => array_flip($THEMEREX_shortcodes_align),
			"type" => "dropdown"
        ...
        array(
			"param_name" => "open",
			"heading" => __("Open form", "themerex"),
            "description" => __("Open search form", "themerex"),
			"class" => "",
			"value" => array(__('Open', 'themerex') => 'yes'),
			"type" => "checkbox"
        ),
        THEMEREX_VC_width(),
		$THEMEREX_VC_margin_top,
...
vc_map( array(
	...
	"description" => __("Custom sidebar", "themerex"),
	"category" => __('Content', 'js_composer'),
	...
	"params" => array(
		array(
            ...
            "description" => __("Sidebar name", "themerex"),
			"class" => "",
			"value" => 0,
			"type" => "textfield"
        ),
		array(
            ...
            "description" => __("Sidebar columns", "themerex"),
			"class" => "",
			"value" => 0,
			"type" => "textfield"
        ),
...
vc_map( array(
	...
	"params" => array(
		array(
            "param_name" => "columns",
            "heading" => __("Columns", "themerex"),
            "description" => __("Number of the columns.", "themerex"),
			"admin_label" => true,
			"class" => "",
			"value" => "2",
			"type" => "textfield"
		...
		array(
			"param_name" => "info",
			"heading" => __("Show teams info block", "themerex"),
			"description" => __("Displays team's info block", "themerex"),
			"class" => "",
			"value" => array("Use scroller" => "yes" ),
			"type" => "checkbox"
		),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			"param_name" => "controls",
			"heading" => __("Controls", "themerex"),
            "description" => __("Displays controls", "themerex"),
			"class" => "",
			"value" => array("Show controls" => "yes" ),
			"type" => "checkbox"
        ),
		array(
			"param_name" => "pagination",
			...
			"class" => "",
			"value" => array("Show pagination" => "yes" ),
			"type" => "checkbox"
        ),
		THEMEREX_VC_width(),
		THEMEREX_VC_height(),
...
vc_map( array(
	...
	"show_settings_on_create" => true,
	"class" => "trx_single trx_sc_testimonials_item",
	"content_element" => true,
	"is_container" => false,
