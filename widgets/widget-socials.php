...
class themerex_social_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo  $this->get_field_id( 'text1' ); ?>"><?php _e('Description 1:', 'themerex'); ?></label>
			<textarea id="<?php echo  $this->get_field_id( 'text1' ); ?>" name="<?php echo  $this->get_field_name( 'text1' ); ?>" style="width:100%;"><?php echo htmlspecialchars($instance['text1']); ?></textarea>
		</p>
		<p>
			<label for="<?php echo  $this->get_field_id( 'logo_image' ); ?>"><?php _e('Logo image:<br />(if empty - use logo from Theme Options)', 'themerex'); ?></label>
			<input id="<?php echo  $this->get_field_id( 'logo_image' ); ?>" name="<?php echo  $this->get_field_name( 'logo_image' ); ?>" value="<?php echo  $logo_image; ?>" style="width:100%;" onchange="jQuery(this).siblings('img').get(0).src=this.value;" />
            <?php
			...
			if ($logo_image) {
			?>
	            <br /><br /><img src="<?php echo  $logo_image; ?>" border="0" width="220" />
			<?php
			}
			?>
		</p>
		...
		<hr>
		<p>
			<label for="<?php echo  $this->get_field_id( 'text2' ); ?>"><?php _e('Description 2:', 'themerex'); ?></label>
			<textarea id="<?php echo  $this->get_field_id( 'text2' ); ?>" name="<?php echo  $this->get_field_name( 'text2' ); ?>" style="width:100%;"><?php echo htmlspecialchars($instance['text2']); ?></textarea>
		</p>
