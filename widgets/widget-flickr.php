...
class themerex_flickr_widget extends WP_Widget {
	 ...
	 * Widget setup.
	 */
	function themerex_flickr_widget() {
		/* Widget settings. */
	...
	function widget( $args, $instance ) {
		...
		<div class="flickr_images">
			<script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=<?php echo  $flickr_count; ?>&amp;flickr_display=random&amp;size=s&amp;layout=x&amp;source=user&amp;user=<?php echo  $flickr_username; ?>"></script>
		</div>
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo  $this->get_field_id( 'flickr_username' ); ?>"><?php _e('Flickr ID (<a href="http://www.idgettr.com" target="_blank">idGettr</a>):', 'themerex'); ?></label>
			<input id="<?php echo  $this->get_field_id( 'flickr_username' ); ?>" name="<?php echo  $this->get_field_name( 'flickr_username' ); ?>" value="<?php echo  $flickr_username; ?>" style="width:100%;" />
		</p>
		<p>
			<label for="<?php echo  $this->get_field_id( 'flickr_count' ); ?>"><?php _e('Number of photos:', 'themerex'); ?></label>
			<input id="<?php echo  $this->get_field_id( 'flickr_count' ); ?>" name="<?php echo  $this->get_field_name( 'flickr_count' ); ?>" value="<?php echo  $flickr_count; ?>" style="width:100%;" />
		</p>
