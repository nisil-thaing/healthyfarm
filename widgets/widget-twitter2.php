...
class Twitter2_Widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p>
			...
			<input id="<?php echo  $this->get_field_id( 'twitter_consumer_key' ); ?>" name="<?php echo  $this->get_field_name( 'twitter_consumer_key' ); ?>" value="<?php echo  $twitter_consumer_key; ?>" style="width:100%;" />
		</p>
		<p>
			<label for="<?php echo  $this->get_field_id( 'twitter_consumer_secret' ); ?>"><?php _e('Twitter Consumer Secret:', 'themerex'); ?></label>
			<input id="<?php echo  $this->get_field_id( 'twitter_consumer_secret' ); ?>" name="<?php echo  $this->get_field_name( 'twitter_consumer_secret' ); ?>" value="<?php echo  $twitter_consumer_secret; ?>" style="width:100%;" />
		</p>
		<p>
			<label for="<?php echo  $this->get_field_id( 'twitter_token_key' ); ?>"><?php _e('Twitter Token Key:', 'themerex'); ?></label>
			<input id="<?php echo  $this->get_field_id( 'twitter_token_key' ); ?>" name="<?php echo  $this->get_field_name( 'twitter_token_key' ); ?>" value="<?php echo  $twitter_token_key; ?>" style="width:100%;" />
		</p>
		<p>
			<label for="<?php echo  $this->get_field_id( 'twitter_token_secret' ); ?>"><?php _e('Twitter Token Secret:', 'themerex'); ?></label>
			<input id="<?php echo  $this->get_field_id( 'twitter_token_secret' ); ?>" name="<?php echo  $this->get_field_name( 'twitter_token_secret' ); ?>" value="<?php echo  $twitter_token_secret; ?>" style="width:100%;" />
		</p>
