...
class themerex_qrcode_widget extends WP_Widget {
	 ...
	 * Widget setup.
	 */
	function themerex_qrcode_widget() {
		/* Widget settings. */
	...
	function form($instance) {
		...
		//themerex_enqueue_style('color-picker', get_template_directory_uri().'/js/colorpicker/colorpicker.css', array(), null);
		//themerex_enqueue_script('color-picker', get_template_directory_uri().'/js/colorpicker/colorpicker.js', array('jquery'),null,true);
		...
		<div class="widget_qrcode">
        	<div class="qrcode_tabs">
                ...
                <div id="tab_text" class="tab_content tab_text">
                    <p>
                        ...
                        <textarea class="fld_text" id="<?php echo esc_attr($this->get_field_id('text')); ?>" name="<?php echo esc_attr($this->get_field_name('text')); ?>" style="width:100%;"><?php echo esc_attr($instance['text']); ?></textarea>
                    </p>
				</div>
            ...
            <p>
                <input class="fld_button_draw" id="<?php echo esc_attr($this->get_field_id('button_draw')); ?>" name="<?php echo esc_attr($this->get_field_name('button_draw')); ?>" value="<?php _e('Update', 'themerex'); ?>" type="button" />
            ...
            <div id="<?php echo esc_attr($this->get_field_id('qrcode_image')); ?>" class="qrcode_image"><img src="<?php echo esc_attr($instance['image']); ?>" /></div>
