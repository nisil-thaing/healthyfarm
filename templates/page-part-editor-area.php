...
if ($post_data['post_edit_enable']) {
	...
	themerex_options_prepare_js( !isset($post_data['post_type']) || $post_data['post_type']=='page' ? 'page' : 'post');
	...
	<div id="frontend_editor">
		<div id="frontend_editor_inner">
			<form method="post">
				...
				<textarea name="frontend_editor_post_excerpt" id="frontend_editor_post_excerpt"><?php echo htmlspecialchars($post_data['post_content_original']); ?></textarea>
