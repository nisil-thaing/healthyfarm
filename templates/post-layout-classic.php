...
<article class="isotopeElement <?php 
	...
	<div class="isotopePadding">
		...
		<div class="thumb hoverIncrease" data-image="<?php echo esc_url($post_data['post_attachment']); ?>" data-title="<?php echo esc_attr($post_data['post_title']); ?>"><?php echo balanceTags($post_data['post_thumb']); ?></div>
		<?php
		...
		?>
		<?php if ($show_title) { ?>
		<h4><a href="<?php echo esc_url($post_data['post_link']); ?>"><?php echo balanceTags($post_data['post_title']); ?></a></h4>
		<?php } ?>
        <p>
		<?php
